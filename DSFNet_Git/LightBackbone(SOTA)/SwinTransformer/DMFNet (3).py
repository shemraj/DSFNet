...
class DMFNet(nn.Module):
    def __init__(self, pretrained=True):
        ...
        #Backbone model
        #self.vgg = VGG('rgb')
        #self.vgg = mobilenet_v2(pretrained)
        self.vgg = SwinTransformer(embed_dim=128, depths=[2, 2, 18, 2], num_heads=[4, 8, 16, 32])
        #............. Encoder...........
        ...
        #.............. RFB ..............
        self.rfb2 = RFB(256, 64)
        self.rfb3 = RFB(512, 64)
        self.rfb4 = RFB(1024, 64)
        self.rfb5 = RFB(1024, 64)

        # self.rfb2 = RFB(128, 64)
        # self.rfb3 = RFB(256, 64)
        # self.rfb4 = RFB(512, 64)
        # self.rfb5 = RFB(512, 64)
        #............... Decoder...........
    ...
    def forward(self, x_rgb):
        ...
        x4_rgb = features[3]
        x5_rgb = features[4]
        #x1_rgb, x2_rgb, x3_rgb, x4_rgb, x5_rgb = self.vgg(x_rgb)
        #.......... Backbone Network..
        print(x1_rgb.size())
        print(x2_rgb.size())
        print(x3_rgb.size())
      ...
      #  x1_en = x1_e * x1_en * x1_d
        ...
        s4 = self.upsample(s4,scale_factor=4)
        s5 = self.upsample(s5, scale_factor=16)

        s2 = self.upsample(s2, scale_factor=2)
        s3 = self.upsample(s3, scale_factor=2)
        s4 = self.upsample(s4, scale_factor=2)
        s5 = self.upsample(s5, scale_factor=2)
        # print(s2.size())
        # print(s3.size())
        # print(s4.size())
        # print(s5.size())
...
#....... Print the network parameters and flops
